...
const registerAsSeller = asyncHandler(async (req, res) => {
  ...
  const seller = await registerSeller(req.user.id, req.body, ipAddress, userAgent);

  res
    .status(201)
    .json(new ApiResponse(201, seller, "Seller registration successful. Pending approval."));
});
...
const getMySellerProfile = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller profile retrieved"));
});
...
const updateMySellerProfile = asyncHandler(async (req, res) => {
  ...
  const seller = await updateSeller(sellerId, req.user.id, req.body, ipAddress, userAgent);

  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller profile updated"));
});
...
const submitDocuments = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, verification, "Documents submitted for verification"));
});
...
const getMyVerificationStatus = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, verification, "Verification status retrieved"));
});
...
const getAllSellers = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Sellers retrieved"));
});
...
const getPendingSellersList = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Pending sellers retrieved"));
});
...
const getSellerDetails = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, result, "Seller details retrieved"));
});
...
const approveSellerHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller approved successfully"));
});
...
const rejectSellerHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller rejected"));
});
...
const suspendSellerHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller suspended"));
});
...
const reactivateSellerHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, seller, "Seller reactivated"));
});
...
const getStoreAnalytics = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, analytics, "Store analytics retrieved"));
});
...
const getStoreSalesHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, report, "Sales report retrieved"));
});
...
const getStoreCustomersHandler = asyncHandler(async (req, res) => {
  ...
  const analytics = await getStoreCustomerAnalytics(storeId, parseInt(days) || 30);
...
const getStoreDailyHandler = asyncHandler(async (req, res) => {
  ...
  res
    .status(200)
    .json(new ApiResponse(200, metrics, "Daily metrics retrieved"));
});
